# ncbi-taxonomy-local [![Build Status](https://app.travis-ci.com/karolisr/ncbi-taxonomy-local.svg?branch=develop)](https://app.travis-ci.com/karolisr/ncbi-taxonomy-local)
